...
/ 138 on all network boundary devices.");
  ...
  script_set_attribute(attribute:"cvss_score_source", value:"CVE-2017-0143");
  ...
  script_copyright(english:"This script is Copyright (C) 2017-2019 and is owned by WebRAY, Inc. ");
