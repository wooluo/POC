...
multiple vulnerabilities as referenced in the 2019_08_stable-channel-update-for-desktop advisory. Note that GizaNE has
...
google_chrome_check_version(fix:'76.0.3809.100', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
