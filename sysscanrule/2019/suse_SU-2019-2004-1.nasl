...
flag = 0;
if (rpm_check(release:"SLES15", sp:"1", cpu:"x86_64", reference:"bzip2-debugsource-1.0.6-5.9.1")) flag++;
...
if (rpm_check(release:"SLED15", sp:"1", cpu:"x86_64", reference:"bzip2-debugsource-1.0.6-5.9.1")) flag++;
