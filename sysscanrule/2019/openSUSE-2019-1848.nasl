...
if ( rpm_check(release:"SUSE15.0", reference:"chromium-76.0.3809.87-lp150.224.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"chromium-debuginfo-76.0.3809.87-lp150.224.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"chromium-debugsource-76.0.3809.87-lp150.224.1") ) flag++;
