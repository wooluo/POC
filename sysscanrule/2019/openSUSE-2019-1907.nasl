...
if ( rpm_check(release:"SUSE15.0", reference:"nodejs8-8.15.1-lp150.2.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"nodejs8-debuginfo-8.15.1-lp150.2.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"nodejs8-debugsource-8.15.1-lp150.2.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"nodejs8-devel-8.15.1-lp150.2.16.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"npm8-8.15.1-lp150.2.16.1") ) flag++;
