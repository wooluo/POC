...
if ( rpm_check(release:"SUSE15.1", reference:"chromium-75.0.3770.80-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"chromium-debuginfo-75.0.3770.80-lp151.2.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.1", reference:"chromium-debugsource-75.0.3770.80-lp151.2.6.1") ) flag++;
