...
if ( rpm_check(release:"SUSE15.0", reference:"tcpdump-4.9.2-lp150.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"tcpdump-debuginfo-4.9.2-lp150.7.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"tcpdump-debugsource-4.9.2-lp150.7.1") ) flag++;
