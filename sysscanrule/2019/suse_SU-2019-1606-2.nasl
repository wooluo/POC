...
if (isnull(sp)) sp = "0";
if (os_ver == "SLES12" && (! ereg(pattern:"^(3|5)$", string:sp))) audit(AUDIT_OS_NOT, "SLES12 SP3/5", os_ver + " SP" + sp);
if (os_ver == "SLED12" && (! ereg(pattern:"^(5)$", string:sp))) audit(AUDIT_OS_NOT, "SLED12 SP5", os_ver + " SP" + sp);
