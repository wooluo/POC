...
if ( rpm_check(release:"SUSE15.0", reference:"squid-4.8-lp150.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"squid-debuginfo-4.8-lp150.9.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"squid-debugsource-4.8-lp150.9.1") ) flag++;
