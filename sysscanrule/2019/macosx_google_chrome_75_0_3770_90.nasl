...
a vulnerability as referenced in the 2019_06_stable-channel-update-for-desktop_13 advisory. Note that GizaNE has not
...
google_chrome_check_version(fix:'75.0.3770.90', severity:SECURITY_HOLE, xss:FALSE, xsrf:FALSE);
