...
if ( rpm_check(release:"SUSE15.0", reference:"gpg2-2.2.5-lp150.3.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"gpg2-debuginfo-2.2.5-lp150.3.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"gpg2-debugsource-2.2.5-lp150.3.10.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"gpg2-lang-2.2.5-lp150.3.10.1") ) flag++;
