...
if (rpm_check(release:"SLES15", sp:"1", cpu:"x86_64", reference:"python3-debugsource-3.6.8-3.16.2")) flag++;
...
if (rpm_check(release:"SLED15", sp:"1", cpu:"x86_64", reference:"python3-debugsource-3.6.8-3.16.2")) flag++;
