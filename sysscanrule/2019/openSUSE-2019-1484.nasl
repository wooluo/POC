...
if (description)
{
  ...
  script_summary(english:"Check for the openSUSE-2019-1484 patch");
...
Security issues fixed (MFSA 2019-15 boo#1135824) :
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1130694"
  );
  script_set_attribute(
    attribute:"see_also",
    value:"https://bugzilla.opensuse.org/show_bug.cgi?id=1133267"
  );
  script_set_attribute(
    attribute:"see_also",
