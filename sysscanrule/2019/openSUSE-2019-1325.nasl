...
if ( rpm_check(release:"SUSE15.0", reference:"chromium-74.0.3729.108-lp150.209.2") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"chromium-debuginfo-74.0.3729.108-lp150.209.2") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"chromium-debugsource-74.0.3729.108-lp150.209.2") ) flag++;
