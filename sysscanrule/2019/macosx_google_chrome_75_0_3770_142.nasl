...
multiple vulnerabilities as referenced in the 2019_07_stable-channel-update-for-desktop advisory. Note that GizaNE has
...
google_chrome_check_version(fix:'75.0.3770.142', severity:SECURITY_HOLE);
