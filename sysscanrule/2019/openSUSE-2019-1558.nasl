...
if ( rpm_check(release:"SUSE15.0", reference:"chromium-75.0.3770.80-lp150.215.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"chromium-debuginfo-75.0.3770.80-lp150.215.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"chromium-debugsource-75.0.3770.80-lp150.215.1") ) flag++;
