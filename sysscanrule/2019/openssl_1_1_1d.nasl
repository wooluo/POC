...
if (description)
{
  script_id(128116);
  script_version("1.1");
  script_cvs_date("Date: 2019/08/23 11:11:54");

  script_cve_id("CVE-2019-1552");
  script_xref(name:"IAVA", value:"2019-A-0303");
  
  script_name(english:"OpenSSL 1.1.1 < 1.1.1d Vulnerability");
...
vulnerability as referenced in the 1.1.1d advisory.
...
openssl_check_version(fixed:"1.1.1d", min:"1.1.1", severity:SECURITY_NOTE);