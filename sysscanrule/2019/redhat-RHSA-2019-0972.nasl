...
{
  flag = 0;
  if (rpm_check(release:"RHEL8", cpu:"aarch64", reference:"libwsman-devel-2.6.5-5.el8")) flag++;
  if (rpm_check(release:"RHEL8", cpu:"i686", reference:"libwsman-devel-2.6.5-5.el8")) flag++;
  if (rpm_check(release:"RHEL8", cpu:"s390x", reference:"libwsman-devel-2.6.5-5.el8")) flag++;
  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"libwsman-devel-2.6.5-5.el8")) flag++;
  ...
  if (rpm_check(release:"RHEL8", cpu:"aarch64", reference:"libwsman1-debuginfo-2.6.5-5.el8")) flag++;
  ...
  if (rpm_check(release:"RHEL8", cpu:"aarch64", reference:"openwsman-client-debuginfo-2.6.5-5.el8")) flag++;
  ...
  if (rpm_check(release:"RHEL8", cpu:"aarch64", reference:"openwsman-debuginfo-2.6.5-5.el8")) flag++;
  ...
  if (rpm_check(release:"RHEL8", cpu:"aarch64", reference:"openwsman-debugsource-2.6.5-5.el8")) flag++;
  ...
  if (rpm_check(release:"RHEL8", cpu:"aarch64", reference:"openwsman-perl-debuginfo-2.6.5-5.el8")) flag++;
  ...
  if (rpm_check(release:"RHEL8", cpu:"aarch64", reference:"openwsman-python3-debuginfo-2.6.5-5.el8")) flag++;
  ...
  if (rpm_check(release:"RHEL8", cpu:"aarch64", reference:"openwsman-server-debuginfo-2.6.5-5.el8")) flag++;
  ...
  if (rpm_check(release:"RHEL8", cpu:"aarch64", reference:"rubygem-openwsman-debuginfo-2.6.5-5.el8")) flag++;
