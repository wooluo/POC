...
{
  flag = 0;
  if (rpm_check(release:"RHEL7", cpu:"i686", reference:"firefox-60.8.0-1.el7_6")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"firefox-60.8.0-1.el7_6")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"firefox-60.8.0-1.el7_6")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"i686", reference:"firefox-debuginfo-60.8.0-1.el7_6")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"s390x", reference:"firefox-debuginfo-60.8.0-1.el7_6")) flag++;

  if (rpm_check(release:"RHEL7", cpu:"x86_64", reference:"firefox-debuginfo-60.8.0-1.el7_6")) flag++;
