...
if (description)
{
  script_id(121508);
  script_version("1.1");
  script_cvs_date("Date: 2019/01/31  9:35:41");

  script_cve_id("CVE-2019-2422");
  script_xref(name:"USN", value:"3875-1");

  script_name(english:"Ubuntu 16.04 LTS / 18.10 : openjdk-8, openjdk-lts vulnerability (USN-3875-1)");
...
if (! ereg(pattern:"^(16\.04|18\.10)$", string:release)) audit(AUDIT_OS_NOT, "Ubuntu 16.04 / 18.10", "Ubuntu " + release);
