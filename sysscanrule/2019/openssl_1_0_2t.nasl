...
if (description)
{
  script_id(128115);
  script_version("1.1");
  script_cvs_date("Date: 2019/08/23 11:07:37");

  script_cve_id("CVE-2019-1552");
  script_xref(name:"IAVA", value:"2019-A-0303");

  script_name(english:"OpenSSL 1.0.2 < 1.0.2t Vulnerability");
...
vulnerability as referenced in the 1.0.2t advisory.
...
openssl_check_version(fixed:"1.0.2t", min:"1.0.2", severity:SECURITY_NOTE);
