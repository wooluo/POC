...
the CVE page(s) listed in the References section."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://access.redhat.com/errata/RHSA-2019:1310"
  );
  script_set_attribute(
    attribute:"see_also",
...
{
  flag = 0;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"thunderbird-60.7.0-1.el6_10")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"thunderbird-60.7.0-1.el6_10")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"thunderbird-60.7.0-1.el6_10")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"i686", reference:"thunderbird-debuginfo-60.7.0-1.el6_10")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"s390x", reference:"thunderbird-debuginfo-60.7.0-1.el6_10")) flag++;
  if (rpm_check(release:"RHEL6", cpu:"x86_64", reference:"thunderbird-debuginfo-60.7.0-1.el6_10")) flag++;
