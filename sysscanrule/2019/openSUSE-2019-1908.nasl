...
if ( rpm_check(release:"SUSE15.0", reference:"evince-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"evince-debuginfo-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"evince-debugsource-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"evince-devel-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"evince-lang-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"evince-plugin-comicsdocument-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"evince-plugin-comicsdocument-debuginfo-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"evince-plugin-djvudocument-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"evince-plugin-djvudocument-debuginfo-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"evince-plugin-dvidocument-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"evince-plugin-dvidocument-debuginfo-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"evince-plugin-pdfdocument-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"evince-plugin-pdfdocument-debuginfo-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"evince-plugin-psdocument-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"evince-plugin-psdocument-debuginfo-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"evince-plugin-tiffdocument-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"evince-plugin-tiffdocument-debuginfo-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"evince-plugin-xpsdocument-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"evince-plugin-xpsdocument-debuginfo-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libevdocument3-4-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libevdocument3-4-debuginfo-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libevview3-3-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"libevview3-3-debuginfo-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"nautilus-evince-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"nautilus-evince-debuginfo-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"typelib-1_0-EvinceDocument-3_0-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
if ( rpm_check(release:"SUSE15.0", reference:"typelib-1_0-EvinceView-3_0-3.26.0+20180128.1bd86963-lp150.3.6.1") ) flag++;
