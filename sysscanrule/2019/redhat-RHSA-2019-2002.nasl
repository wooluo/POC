...
{
  flag = 0;
  if (rpm_check(release:"RHEL8", cpu:"s390x", reference:"redis-5.0.3-2.module+el8.0.0.z+3657+acb471dc")) flag++;
  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"redis-5.0.3-2.module+el8.0.0.z+3657+acb471dc")) flag++;
  if (rpm_check(release:"RHEL8", cpu:"s390x", reference:"redis-debuginfo-5.0.3-2.module+el8.0.0.z+3657+acb471dc")) flag++;
  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"redis-debuginfo-5.0.3-2.module+el8.0.0.z+3657+acb471dc")) flag++;
  if (rpm_check(release:"RHEL8", cpu:"s390x", reference:"redis-debugsource-5.0.3-2.module+el8.0.0.z+3657+acb471dc")) flag++;
  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"redis-debugsource-5.0.3-2.module+el8.0.0.z+3657+acb471dc")) flag++;
  if (rpm_check(release:"RHEL8", cpu:"s390x", reference:"redis-devel-5.0.3-2.module+el8.0.0.z+3657+acb471dc")) flag++;
  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"redis-devel-5.0.3-2.module+el8.0.0.z+3657+acb471dc")) flag++;
  if (rpm_check(release:"RHEL8", reference:"redis-doc-5.0.3-2.module+el8.0.0.z+3657+acb471dc")) flag++;
