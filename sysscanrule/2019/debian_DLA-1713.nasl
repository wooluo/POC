...
# extracted from Debian Security Advisory DLA-1713-1. The text
...
if (description)
{
  ...
  script_name(english:"Debian DLA-1713-1 : libsdl1.2 security update");
...
introducing additional issues."
  ...
  script_set_attribute(
    attribute:"see_also",
    value:"https://lists.debian.org/debian-lts-announce/2019/03/msg00015.html"
  );
  script_set_attribute(
    attribute:"see_also",
...
flag = 0;
if (deb_check(release:"8.0", prefix:"libsdl1.2-dbg", reference:"1.2.15-10+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libsdl1.2-dev", reference:"1.2.15-10+deb8u1")) flag++;
if (deb_check(release:"8.0", prefix:"libsdl1.2debian", reference:"1.2.15-10+deb8u1")) flag++;
