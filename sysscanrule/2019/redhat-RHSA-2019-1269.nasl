...
{
  flag = 0;
  if (rpm_check(release:"RHEL8", cpu:"s390x", reference:"firefox-60.7.0-1.el8_0")) flag++;
  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"firefox-60.7.0-1.el8_0")) flag++;
  if (rpm_check(release:"RHEL8", cpu:"s390x", reference:"firefox-debuginfo-60.7.0-1.el8_0")) flag++;
  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"firefox-debuginfo-60.7.0-1.el8_0")) flag++;
  if (rpm_check(release:"RHEL8", cpu:"s390x", reference:"firefox-debugsource-60.7.0-1.el8_0")) flag++;
  if (rpm_check(release:"RHEL8", cpu:"x86_64", reference:"firefox-debugsource-60.7.0-1.el8_0")) flag++;
