...
if (rpm_check(release:"SLES15", sp:"1", cpu:"x86_64", reference:"python-base-debugsource-2.7.14-7.14.2")) flag++;
...
if (rpm_check(release:"SLED15", sp:"1", cpu:"x86_64", reference:"python-base-debugsource-2.7.14-7.14.2")) flag++;
