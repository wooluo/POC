...
Note that webray could not check for any of the flaws and solely
relied on the presence of the service to issue an alert, so this might
be a false positive.");
 script_set_attribute(attribute:"see_also", value:"http://www.webray.org/u?34bb0fc8");
 ...
 script_copyright(english:"Copyright (C) 2003-2018 WebRAY");
...
req = raw_string(
		 ...
		 0xA2, 0x0F, 0x1B, 0x0D,
		 0x43, 0x4E, 0x2E, 0x57, 0x45, 0x42, 0x52, 0x41,
		 0x59, 0x2E, 0x4F, 0x52, 0x47, 0xA3, 0x22, 0x30,
