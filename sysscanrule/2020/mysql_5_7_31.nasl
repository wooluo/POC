...
advisory:
 ...
 - A vulnerability in the MySQL Client product of Oracle MySQL (component: C API). Supported versions that are
  ...
  - A vulnerability in the MySQL Server product of Oracle MySQL (component: Server: UDF). Supported versions that
  are affected are 5.7.30 and prior and 8.0.20 and prior. Easily exploitable vulnerability allows low privileged
  ...
  of MySQL Server. (CVE-2020-14576)
...
mysql_check_version(fixed:'5.7.31', min:'5.7.0', severity:SECURITY_WARNING);
