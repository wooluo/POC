#TRUSTED 
#
# 
#
...
affected Client SSL profile.");
  ...
  script_dependencies("ssl_supported_versions.nasl","f5_bigip_detect.nbin");
  script_require_keys("Host/BIG-IP/version");
...
function attack(port, ciphers)
{
  ...
  if (rec["session_id"] == session_id)
    return [FALSE, "session_id_mismatch", "Server replied with a session ID that matches exactly what GizaNE sent."];
  ...
  if (strlen(rec["session_id"]) > strlen(session_id) && substr(rec["session_id"], 0, strlen(session_id) - 1) == session_id)
    return [
      TRUE,
      "session_id_length",
      "GizaNE sent the " + strlen(session_id) + "-byte session ID " + hexstr(session_id) + ". The server replied with the " + strlen(rec["session_id"]) + "-byte session ID " + hexstr(rec["session_id"]) + "."
    ];
