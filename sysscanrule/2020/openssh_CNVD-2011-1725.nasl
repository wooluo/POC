...
if (description)
{
  ...
  script_name(english:"OpenSSH < 5.8 Multiple DoS");
...
vulnerabilities.");
  script_set_attribute(attribute:"description", value:"Portable OpenSSH's ssh-keysign utility may allow unauthorised local access to host keys on platforms if ssh-rand-helper is used.");

  script_set_attribute(attribute:"see_also", value:"https://www.cnvd.org.cn/flaw/show/CNVD-2011-1725");
  script_set_attribute(attribute:"see_also",value:"http://www.openssh.com/txt/portable-keysign-rand-helper.adv");
  script_set_attribute(attribute:"solution", value:"Upgrade to OpenSSH 5.8p2 or later.");
