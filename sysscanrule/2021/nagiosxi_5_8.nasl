...
if (description)
{
  ...
  script_set_attribute(attribute:"synopsis", value:"The remote host has a web application affected by a privilege escalation vulnerability.");
...
number.");
  ...
  script_set_attribute(attribute:"solution", value:"Upgrade to Nagios XI 5.8.0 or above.");
