...
if (description)
{
  ...
  script_cve_id("CVE-2019-11072");

  script_name(english:"lighttpd < 1.4.54 Multiple Vulnerabilities");
...
"Upgrade to lighttpd version 1.4.54 or later.");
...
constraints = [{"fixed_version":"1.4.54"}];
