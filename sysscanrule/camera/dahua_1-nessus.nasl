...
# Copyright @WebRAY  /opt/nessus/bin/nasl -k time172.18.253.11.kb -Xt 223.241.197.109 dahua_1-nessus.nasl
############################################################
include("compat.inc");
...
if (description)
{
  script_id(51799133);
  script_version("1.3");
  script_name(english:"dahua DSS device Unauthorized access");
  script_summary(english:"dahua DSS device Unauthorized access");
  script_set_attribute(attribute:"description", value:"dahua DSS device Unauthorized access");
...
function check_vuln(port){
	url = string('/emap/gis/page/bitmap/config_bitmap.jsp');
	...
	if("200 O">< req[0] && "/emap/gis/page/common/menu.jsp?isConfig=true" >< req[2] && 'class="btn_ico ico_exit_fullscreen"' >< req[2]){
...
function check_vuln_ssl(port){
	...
	if("200 O"><ssl_req && "/emap/gis/page/common/menu.jsp?isConfig=true" >< ssl_req && 'class="btn_ico ico_exit_fullscreen"' >< ssl_req){
